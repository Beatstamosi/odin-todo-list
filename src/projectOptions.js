...
function setMaxDateAttributeDependingOnProjectDueDate(selectField, list, initialProjectName) {
    ...
    const setMaxDate = (projectName) => {
        const selectedProject = list.find(project => project.name === projectName);
